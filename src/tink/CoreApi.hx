...
typedef Surprise<D, F> = tink.core.Surprise<D, F>;
...
typedef MPair<A, B> = tink.core.MPair<A, B>;

typedef Signal<T> = tink.core.Signal<T>;
typedef SignalTrigger<T> = tink.core.SignalTrigger<T>;
...
typedef CallbackLink = tink.core.CallbackLink;
typedef CallbackList<T> = tink.core.CallbackList<T>;
